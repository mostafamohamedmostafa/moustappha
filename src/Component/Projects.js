                            ...
                            <div className="col Projects-Card" key={index} data-aos="fade-down" >
                                <div className="card h-100">
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title"><strong>Project Name:</strong>{ProjectsMadendata.ProjectName}</h5>
                                        <p className="card-text"><strong>Project Description:</strong> {ProjectsMadendata.ProjectDescription}</p>
                                        <p className="card-text"><strong>Project Technologies:</strong> {ProjectsMadendata.ProjectTechnologies}</p>
